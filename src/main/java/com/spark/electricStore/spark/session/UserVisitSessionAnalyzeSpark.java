package com.spark.electricStore.spark.session;
...
import com.spark.electricStore.domain.*;
import com.spark.electricStore.test.MockData;
import com.spark.electricStore.util.*;
import com.spark.electricStore.util.*;
...
//			return;
//		}
		String testParam = "{\"startAge\":[\"10\"],\"endAge\":[\"50\"],\"startDate\":[\"2020-02-22\"],\"endDate\":[\"2020-02-22\"]}";
...
//				top10CategoryList, sessionid2detailRDD);
	...
	private static JavaRDD<Row> getActionRDDByDateRange(
		...
		String endDate = ParamUtils
                .getParam(taskParam, Constants.PARAM_END_DATE);
...
//				});
	...
	private static void randomExtractSession(
		 ...
		 */
		Map<String, Map<String, List>> fastutilDateHourExtractMap =
		...
		for(Map.Entry<String, Map<String, List<Integer>>> dateHourExtractEntry :
			...
			Map<String, List> fastutilHourExtractMap = new HashMap<String, List>();

			for(Map.Entry<String, List<Integer>> hourExtractEntry : hourExtractMap.entrySet()) {
				String hour = hourExtractEntry.getKey();
				List<Integer> extractList = hourExtractEntry.getValue();

				List fastutilExtractList = new ArrayList();
		...
		final Broadcast<Map<String, Map<String, List>>> dateHourExtractMapBroadcast =
		...
		JavaPairRDD<String, String> extractSessionidsRDD = time2sessionsRDD.flatMapToPair(
				...
				new PairFlatMapFunction<Tuple2<String,Iterable<String>>, String, String>() {
					...
					public Iterator<Tuple2<String, String>> call(
						 ...
						 * 可以获取到之前封装的广播变量
						 */
						Map<String, Map<String, List>> dateHourExtractMap =
